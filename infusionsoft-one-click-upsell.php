...
class ns_is_one_click_upsell {
    ...
    public function __construct()
    {
        ...
        add_shortcode('upsell', array($this, 'shortcode_upsell'));
        add_shortcode('downsell', array($this, 'shortcode_downsell'));

        // Add shortcode AJAX handlers
        add_action('wp_ajax_process_upsell', array($this, 'process_upsell'));
        add_action('wp_ajax_nopriv_process_upsell', array($this, 'process_upsell'));
    }
     ...
     * @return string
     */
    public function shortcode_upsell($attributes){
        ...
        if(isset($_GET['contactId'])) {
            ...
            $contact_id = $this->get_contact_id($order_id, $_GET['inf_field_FirstName'], $_GET['inf_field_LastName']);
...
CSS;
    ...
    public function admin_menu()
    {
        ...
        add_menu_page( "Infusionsoft One-click Upsell", "One-click Upsell", "manage_options", "novaksolutions_upsell_admin_menu", array($this, "admin_page") );
        add_submenu_page( "novaksolutions_upsell_admin_menu", "Infusionsoft One-click Upsell", "Settings", "manage_options", "novaksolutions_upsell_admin_menu", array($this, "admin_page"));
        add_submenu_page( "novaksolutions_upsell_admin_menu", "One-click Upsell Usage Instructions", "Usage", "edit_posts", "novaksolutions_upsell_usage", array($this, "display_usage"));
        add_submenu_page( "novaksolutions_upsell_admin_menu", "Product Upsell Links", "Product Upsell Links", "edit_posts", "novaksolutions_upsell_product_links", array($this, "display_product_links"));
    ...
    public function admin_init()
    {
        ...
        add_settings_field(
            ...
            'Merchant Account ID',
            array($this, 'field_merchantaccount_id'),
            'novaksolutions-upsell-settings',
            'novaksolutions_upsell_setting_section_app'
        );
        ...
        add_settings_field(
            ...
            array($this, 'field_test_merchantaccount_id'),
            'novaksolutions-upsell-settings',
            'novaksolutions_upsell_setting_section_app'
        );
        ...
        add_settings_field(
            ...
            'Default Success URL',
            array($this, 'field_default_success_url'),
            'novaksolutions-upsell-settings',
            'novaksolutions_upsell_setting_section_defaults'
        );
        ...
        add_settings_field(
            ...
            'Default Failure URL',
            array($this, 'field_default_failure_url'),
            'novaksolutions-upsell-settings',
            'novaksolutions_upsell_setting_section_defaults'
        );
        ...
        add_settings_field(
            ...
            'Default Button Text',
            array($this, 'field_default_button_text'),
            'novaksolutions-upsell-settings',
            'novaksolutions_upsell_setting_section_defaults'
        );
        ...
        add_settings_field(
            ...
            array($this, 'field_default_action_set_id'),
            'novaksolutions-upsell-settings',
            'novaksolutions_upsell_setting_section_defaults'
        );
        ...
        add_settings_field(
            ...
            array($this, 'field_default_class'),
            'novaksolutions-upsell-settings',
            'novaksolutions_upsell_setting_section_defaults'
        );
        ...
        add_settings_field(
            ...
            array($this, 'field_default_image'),
            'novaksolutions-upsell-settings',
            'novaksolutions_upsell_setting_section_defaults'
        );
        ...
        add_settings_field(
            ...
            array($this, 'field_default_image_width'),
            'novaksolutions-upsell-settings',
            'novaksolutions_upsell_setting_section_defaults'
        );
        ...
        add_settings_field(
            ...
            array($this, 'field_default_image_height'),
            'novaksolutions-upsell-settings',
            'novaksolutions_upsell_setting_section_defaults'
        );

        // Register our setting
        register_setting('novaksolutions-upsell-settings', 'novaksolutions_upsell_merchantaccount_id', array($this, 'callback_sanitize_absint'));
        register_setting('novaksolutions-upsell-settings', 'novaksolutions_upsell_test_merchantaccount_id', array($this, 'callback_sanitize_absint'));
        ...
        register_setting('novaksolutions-upsell-settings', 'novaksolutions_upsell_default_action_set_id', array($this, 'callback_sanitize_absint'));
        ...
        register_setting('novaksolutions-upsell-settings', 'novaksolutions_upsell_default_image_width', array($this, 'callback_sanitize_absint'));
        register_setting('novaksolutions-upsell-settings', 'novaksolutions_upsell_default_image_height', array($this, 'callback_sanitize_absint'));
    }

    /**
     * Display success URL field
     */
    public function field_default_success_url() {
     ...
     */
    public function field_default_failure_url() {
     ...
     */
    public function field_default_button_text() {
     ...
     */
    public function field_merchantaccount_id() {
        $merchantId = $this->get_merchant_accounts();
     ...
     */
    public function field_test_merchantaccount_id() {
     ...
     */
    public function field_default_action_set_id() {
     ...
     */
    public function field_default_id() {
     ...
     */
    public function field_default_class() {
     ...
     */
    public function field_default_image_width() {
     ...
     */
    public function field_default_image_height() {
     ...
     * @return int
     */
    public function callback_sanitize_absint($value) {
        $value = absint($value);
    ...
    public function display_link_back(){
    ...
    public function display_product_links(){
     ...
     * @return int
     */
    public function get_contact_id($orderId, $firstName, $lastName) {
    ...
    public function process_upsell(){
        ...
        try {
            ...
            if($authed){
                ...
                if (!$error) {
                    header('Location: ' . $this->add_params_to_url($success_url, $pass_along_params));
                } else{
...
$ns_is_one_click_upsell = new ns_is_one_click_upsell();
